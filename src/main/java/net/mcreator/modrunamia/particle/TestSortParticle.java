...
package net.mcreator.modrunamia.particle;
...
public class TestSortParticle extends ModRunamiaModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public TestSortParticle(ModRunamiaModElements instance) {
		super(instance, 51);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("test_sort"));
	}
