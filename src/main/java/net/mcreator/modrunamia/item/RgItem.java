...
public class RgItem extends ModRunamiaModElements.ModElement {
	@ObjectHolder("mod_runamia:rg_helmet")
	public static final Item helmet = null;
	@ObjectHolder("mod_runamia:rg_chestplate")
	public static final Item body = null;
	@ObjectHolder("mod_runamia:rg_leggings")
	public static final Item legs = null;
	@ObjectHolder("mod_runamia:rg_boots")
	public static final Item boots = null;
	public RgItem(ModRunamiaModElements instance) {
		super(instance, 25);
	}
