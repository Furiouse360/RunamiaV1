...
public class BouleDeFeuxSortItem extends ModRunamiaModElements.ModElement {
	@ObjectHolder("mod_runamia:boule_de_feux_sort")
	public static final Item block = null;
	@ObjectHolder("mod_runamia:entitybulletboule_de_feux_sort")
	public static final EntityType arrow = null;
	public BouleDeFeuxSortItem(ModRunamiaModElements instance) {
		super(instance, 50);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletboule_de_feux_sort").setRegistryName("entitybulletboule_de_feux_sort"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("boule_de_feux_sort");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(BouleDeFeuxItem.block, (int) (1));
		}
