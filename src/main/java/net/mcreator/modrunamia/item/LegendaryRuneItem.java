...
public class LegendaryRuneItem extends ModRunamiaModElements.ModElement {
	@ObjectHolder("mod_runamia:legendary_rune")
	public static final Item block = null;
	public LegendaryRuneItem(ModRunamiaModElements instance) {
		super(instance, 12);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("legendary_rune");
		}
