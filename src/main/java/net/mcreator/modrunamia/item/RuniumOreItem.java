...
public class RuniumOreItem extends ModRunamiaModElements.ModElement {
	@ObjectHolder("mod_runamia:runium_ore")
	public static final Item block = null;
	public RuniumOreItem(ModRunamiaModElements instance) {
		super(instance, 31);
	}
