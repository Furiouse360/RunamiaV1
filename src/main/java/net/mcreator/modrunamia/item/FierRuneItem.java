...
public class FierRuneItem extends ModRunamiaModElements.ModElement {
	@ObjectHolder("mod_runamia:fier_rune")
	public static final Item block = null;
	public FierRuneItem(ModRunamiaModElements instance) {
		super(instance, 10);
	}
